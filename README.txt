...
- Create a MS-SQL database and create all the required schemas(Please, refer MemberDatabase project which contains all the required queries to be executed to support the application).
